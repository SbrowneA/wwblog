...
urlpatterns = [
    ...
    path('post/me', views.manage_own_content, name='browse_own_articles'),
    ...
    path('category/<str:category_id>/edit', views.edit_category, name='edit_category'),
    path('category/<str:category_id>/new', views.create_sub_category, name='add_sub_category'),
    path('category/<str:category_id>/delete', views.delete_category, name='add_sub_category'),
    path('category/createproject', views.create_project, name='edit_category'),
